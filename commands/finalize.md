---
description: Validate completion, sync delta specs, archive, commit, and optionally open a PR/MR
argument-hint: [change-id]
model: inherit
effort: medium
allowed-tools: Read, Write, Bash, AskUserQuestion, mcp__plugin_wspec_wspec
---
